...
def pi(x, b):                          #  0        1      2,    3    4  5
    ...
    V = []
    PixV = []
    n_steps = 381 # 190*2 #401  #1601
    step_size = 0.2481 # 0.062025 #0.12405 # in mm 0.2481/2
    ...
    return PixV[int((x/(2.0*step_size))*2) + int(0.5*n_steps)] + b[5] #973   # x in mm
                                                # 983 gave 0.88 in 3
                                                # 993 gave 0.89 in 4
                                                # 973 gave 0.89 in 5
                                                  # 401 pts gave 0.65 in 6
                                                  # 381 pts gave 0.647 in 7
...
x0 = array([0.521, 0.201,   0.0294,       2015.0, 1.4, 983]) # initial values for minimize
#x0 = array([0.50796, 0.22127,   0.0295,   983.0, 1884.0, 1.40]) # initial values for minimize
#x0 = array([0.50066, 0.19,   0.029459,   992.17, 1936.8, 1.3958]) # initial values for minimize



print ( x0 )
res = minimize(s, x0, method='nelder-mead', options={'xtol': 1e-4, 'disp': True, 'maxfev':1e4, 'maxiter':1e4} )
print (res.x)
#print ( s(x0)*1e-6 )
print (res.fun *1e-6)
...
#    print(x,", ", line_array[line_len_2 - 95 + i][1],", ",pi(x,x0) )
